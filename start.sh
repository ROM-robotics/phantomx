...
sleep 3
gnome-terminal --name="Driver" -e "roslaunch phantomx_reactor_arm_controller dynamixel_phantomx_reactor_arm_none_wrist.launch"

sleep 3
gnome-terminal --name="Rviz" -e "roslaunch phantomx_no_wrist_moveit demo_real.launch"
